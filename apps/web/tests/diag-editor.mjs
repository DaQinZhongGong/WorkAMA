...
await page.goto('http://localhost:3000/studio/apps/ast_01KYPAZMZMV5N14YYSAY4WTQQ4/editor',{waitUntil:'networkidle'})
await page.waitForTimeout(3000)
console.log('url', page.url())
console.log('h', await page.locator('h1,h2').allInnerTexts())
console.log('body', (await page.locator('main').innerText().catch(()=>'')).slice(0,2500))
await browser.close()
